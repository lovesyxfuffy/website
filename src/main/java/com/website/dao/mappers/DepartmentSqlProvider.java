...
import com.website.dao.po.DepartmentExample.Criteria;
import com.website.dao.po.DepartmentExample.Criterion;
...
public class DepartmentSqlProvider {
    ...
    public String insertSelective(Department record) {
        ...
        if (record.getDepartmentcontent() != null) {
            sql.VALUES("departmentContent", "#{departmentcontent,jdbcType=VARCHAR}");
        }
        
        if (record.getDepartmentarticlelink() != null) {
            sql.VALUES("departmentArticleLink", "#{departmentarticlelink,jdbcType=VARCHAR}");
        }
    ...
    public String selectByExample(DepartmentExample example) {
        ...
        sql.SELECT("departmentContent");
        sql.SELECT("departmentArticleLink");
        sql.FROM("department");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getDepartmentname() != null) {
            sql.SET("departmentName = #{record.departmentname,jdbcType=VARCHAR}");
        }
        
        if (record.getDepartmentcontent() != null) {
            sql.SET("departmentContent = #{record.departmentcontent,jdbcType=VARCHAR}");
        }
        
        if (record.getDepartmentarticlelink() != null) {
            sql.SET("departmentArticleLink = #{record.departmentarticlelink,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(Department record) {
        ...
        if (record.getDepartmentcontent() != null) {
            sql.SET("departmentContent = #{departmentcontent,jdbcType=VARCHAR}");
        }
        
        if (record.getDepartmentarticlelink() != null) {
            sql.SET("departmentArticleLink = #{departmentarticlelink,jdbcType=VARCHAR}");
        }
