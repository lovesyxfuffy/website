...
import com.website.dao.po.ProjectExample.Criteria;
import com.website.dao.po.ProjectExample.Criterion;
...
public class ProjectSqlProvider {
    ...
    public String insertSelective(Project record) {
        ...
        if (record.getProjectimgurl() != null) {
            sql.VALUES("projectImgUrl", "#{projectimgurl,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(Project record) {
        ...
        if (record.getArticlelink() != null) {
            sql.SET("articleLink = #{articlelink,jdbcType=VARCHAR}");
        }
        
        if (record.getProjectimgurl() != null) {
            sql.SET("projectImgUrl = #{projectimgurl,jdbcType=VARCHAR}");
        }
